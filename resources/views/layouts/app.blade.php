...
<body class="">
    ...
    <div id="app" class="h-screen bg-gray-100 overflow-hidden">
                ...
                <div class="fixed top-1/2 left-1/2 w-96 h-96 transform -translate-y-2/3 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse animation-delay-1000"></div>
                ...
                <div class="fixed top-1/2 left-1/2 w-96 h-96 bg-fuchsia-400 transform -translate-y-2/3 -translate-x-96 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse animation-delay-4000"></div>
